...
export default function NewSongPage() {
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative max-w-lg mx-auto px-8 py-14 space-y-6">
        <Link href="/" className="text-sm text-ink/50 hover:text-ink">
          ← Back
        </Link>
        <h1 className="font-display text-4xl text-ink">New song</h1>

        <div className="rounded-3xl bg-cream-deep border border-ink/10 p-8 shadow-[0_20px_48px_-24px_rgba(43,43,43,0.35)]">
          <NewSongForm />
        </div>
      </div>
    </main>
